...
class plgSystemVMProductLocExcludeInstallerScript {
	...
	private function fixManifest($adapter) {
		$filesource = $adapter->get('parent')->getPath('source').'/vmProductLocExclude_j3.xml';
		$filedest = $adapter->get('parent')->getPath('extension_root').'/vmProductLocExclude.xml';
